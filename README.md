...
EBlink ARM Cortex-M debug tool with squirrel scripting device support
 ...
 [ Windows installer V3.6 - stable ](https://www.embitz.org/EBlinkInstaller.zip)  (MD5: 88cebe2279e0c02739ad3ac4deecda41 ) **The installer always has the latest script commits.** Just download and use the latest installer, which will uninstall the current if needed, to update EBlink at the same installation location as the previous.
